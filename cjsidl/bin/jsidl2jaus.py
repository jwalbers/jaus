...
# TODO: get xmlns from input file.
...
def emit_vtag_field(e,level,outf):    
    ...
    try:
        ...
        # Subtract 1 for the <vtag_field/> element.
...
def emit_sequence(e,level,outf,prefix='',suffix='',parent_type=''):
    ...
    for c in e:
        ...
        if stag ==  'presence_vector':
            # We no longer emit explicit presence_vector in CJSIDL, implied by optional/required.
...
def emit_type(e,level,outf,prefix='',suffix='', parent_type=''):
    ...
    try:
        ...
        # tag for comment item seems to be a builtin_function_or_method.
        return
